    ...
    return (
        ...
        <div className='project-box fadeIn ftco-animated'>
            ...
            <div className='p-4'>
                ...
                <p className='project-read'><a href='https://github.com/comstering/IMCP'>Read more <span class='icon-font ion-ios-arrow-forward' /></a> IMCP</p>
            </div>
        </div>
        <div className='project-box fadeIn ftco-animated'>
            ...
            <div className='p-4'>
                ...
                <p className='project-read'><a href='https://github.com/comstering/Lab_IoT_Arduino'>Read more <span class='icon-font ion-ios-arrow-forward' /></a> IoT Arduino</p>
                <p className='project-read'><a href='https://github.com/comstering/Lab_IoT_Arduino_Server'>Read more <span class='icon-font ion-ios-arrow-forward' /></a> IoT Server</p>
            </div>
        </div>
        <div className='project-box fadeIn ftco-animated'>
            ...
            <div className='p-4'>
                ...
                <p className='project-read'><a href='https://github.com/comstering/RandomPassword'>Read more <span class='icon-font ion-ios-arrow-forward' /></a> Random Password</p>
                <p className='project-read'><a href='https://github.com/comstering/RandomPassword_Server'>Read more <span class='icon-font ion-ios-arrow-forward' /></a> Random Password Server</p>
            </div>
        </div>
        </div>
    )
